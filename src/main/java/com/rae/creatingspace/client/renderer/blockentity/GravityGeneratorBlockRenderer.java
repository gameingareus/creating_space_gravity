...
public class GravityGeneratorBlockRenderer extends KineticBlockEntityRenderer<GravityGeneratorBlockEntity> {

    public GravityGeneratorBlockRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(GravityGeneratorBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
